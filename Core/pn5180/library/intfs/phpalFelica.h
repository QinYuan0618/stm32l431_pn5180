...
/**
* \brief Get Request Data(RD). Digital Protocol v2.3, Section 8.6.2, SENSF_RES Response).
* 1. Request Data(optional bytes) indicates Advanced Protocol Features information (Byte 18 and 19 of SENSF_RES).
* 2. Higher byte(Byte 18 of SENSF_RES) is always zero(RFU).
* 3. Lower byte(Byte 19 of SENSF_RES) indicates supported bit rates(bit 1 to 4) and Automatically selectable bit rates supported(bit 8) information.
* Note: If RD or SENSF_RES not available, GetConfig returns 0.
*/
#define PHPAL_FELICA_RD                             0x0003U
