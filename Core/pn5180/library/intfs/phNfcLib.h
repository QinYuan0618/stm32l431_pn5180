...
#if defined (NXPBUILD__PHAL_MFDFLIGHT_SW) || defined (NXPBUILD__PHAL_MFDFLIGHT_SAM_NONX)
#include <phalMfdfLight.h>
#endif /* defined (NXPBUILD__PHAL_MFDFLIGHT_SW) || defined (NXPBUILD__PHAL_MFDFLIGHT_SAM_NONX) */

#if defined (NXPBUILD__PHAL_MFNTAG42XDNA_SW) || defined (NXPBUILD__PHAL_MFNTAG42XDNA_SAM_NONX)
#include <phalMfNtag42XDna.h>
#endif /* defined (NXPBUILD__PHAL_MFNTAG42XDNA_SW) || defined (NXPBUILD__PHAL_MFNTAG42XDNA_SAM_NONX) */
