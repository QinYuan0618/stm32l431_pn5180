...
/** \name Maximum blocks supported by ICODE with extended memory. */
/* @{ */
#ifndef PHAL_ICODE_MAX_BLOCKS_EXTENDED
#define PHAL_ICODE_MAX_BLOCKS_EXTENDED                                  512U    /**< Maximum blocks supported by ICODE specification for Extended operations.
*    NOTE: User can change this value based on the PICC memory size and organization.
*/
/* @} */
#endif /* PHAL_ICODE_MAX_BLOCKS_EXTENDED */
