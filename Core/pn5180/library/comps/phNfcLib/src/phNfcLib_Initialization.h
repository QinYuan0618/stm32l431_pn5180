...
typedef struct
{
    ...
    phalMfDuoX_Sw_DataParams_t         salMFDuoX;          /* AL MF DUOX component */
    ...
    phCryptoASym_mBedTLS_DataParams_t  sCryptoAsym;        /* Crypto Asym mbedtls software component */
    ...
    #ifdef NXPBUILD__PHAL_MFPEVX_SW
    phCryptoSym_mBedTLS_DataParams_t   sCryptoSymDiversify;/* Crypto Sym Diversify mbedtls component */
    #endif /* NXPBUILD__PHAL_MFPEVX_SW */
