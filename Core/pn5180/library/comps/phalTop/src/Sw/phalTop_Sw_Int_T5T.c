                                    ...
                                    )
{
    ...
    if (wBlockNum > pT5T->wMaxBlockNum)
    {
                                          ...
                                          )
{
    ...
    {
        for(wIndex = 0; wIndex < pT5T->wMaxBlockNum; wIndex++)
        {
                                              ...
                                              )
{
    ...
    while(wBlockNum <= pT5T->wMaxBlockNum)
    {
        wIndex = 0;
                                        ...
                                        )
{
    ...
    *pTagState = PHAL_TOP_STATE_NONE;
    ...
    pT5T->wMaxBlockNum = (((pT5T->wMlen * 8U /* */) / pT5T->bBlockSize) + (pT5T->bCcLength / pT5T->bBlockSize));
                                        ...
                                        )
{
    ...
    if(0U != wLoopCount)
    {
        ...
        for(wLoopCount = 0; ((wLoopCount < ((dwLength - wBytesUsed) / pT5T->bBlockSize)) && ((wBlockNum + wLoopCount) <= pT5T->wMaxBlockNum)); wLoopCount++)
        {
            PH_CHECK_SUCCESS_FCT(status, phalTop_Sw_Int_T5T_Write(
                pT5T,
