...
{ \
    DEBUG_PRINTF("Line: %d Success - Function executed successfully (0x%04X)\n", __LINE__, (x)); \
}
...
{ \
    DEBUG_PRINTF("Line: %d Success - Operation completed successfully (0x%04X)\n", __LINE__, (x)); \
}
...
{ \
    DEBUG_PRINTF("Line: %d [OK] NFCLIB Status: 0x%04lX\n", __LINE__, (x)); \
}
